...
"""
3-Layer CNN with 3 Adaptive Kernel Selection Layers
3-layer CNN architecture with adaptive kernel selection after each conv layer
"""
import torch
...
def run_experiment(seeds=[1, 24, 65], num_epochs=50, dataset='cifar10'):
    ...
    for seed in seeds:
        ...
        torch.manual_seed(seed)
        standard_model = StandardCNN(num_classes=num_classes)
...
if __name__ == "__main__":
    ...
    results = run_experiment(seeds=[1, 24, 65], num_epochs=65, dataset='cifar100')
